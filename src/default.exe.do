...
gcc -std=gnu11 -Wall -Wextra -Wshadow -Wstrict-overflow -fno-strict-aliasing -Wno-missing-field-initializers $LD_FLAGS -O2 -g -fsanitize=undefined -o $3 $2.o $DEPS -lcad -lyacjp -luv
